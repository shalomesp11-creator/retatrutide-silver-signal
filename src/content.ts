...
export const products: readonly Product[] = [
  {
    ...
    bundles: [
      { name: "Starter", quantity: 1, supply: "1 unit", price: "€52.11", original: "€61.30", unit: "€52.11 / unit", saving: "15% off" },
      { name: "Performance", quantity: 3, supply: "3 units · buy 3 & save", price: "€156.33", original: "€183.90", unit: "€52.11 / unit", saving: "15% off", popular: true },
      { name: "Pro cycle", quantity: 5, supply: "5 units · best value", price: "€260.55", original: "€306.50", unit: "€52.11 / unit", saving: "15% off" },
    ],
  },
  {
    id: "20",
    ...
    bundles: [
      { name: "Starter", quantity: 1, supply: "1 unit", price: "€90.27", original: "€106.20", unit: "€90.27 / unit", saving: "15% off" },
      { name: "Performance", quantity: 3, supply: "3 units · 3-month supply", price: "€270.81", original: "€318.60", unit: "€90.27 / unit", saving: "15% off", popular: true },
      { name: "Pro cycle", quantity: 5, supply: "5 units · 5-month supply", price: "€451.35", original: "€531.00", unit: "€90.27 / unit", saving: "15% off" },
    ],
  },
] as const;
